...
Current baseline (2026-05-08 S68 close): **9,425 pass / 49 skip / 1 todo / 0 fail** (full suite); **~8,743 pre-commit subset**. +184 net pass / +5 skip / 0 regressions from S67 close. **A5-1 SPEC AMENDMENTS LANDED** (§51.0.K Machine Cohesion footnote + §51.0.M `<onTimeout>` + §51.0.N `history` attribute + §51.0.O `internal:rule=` + §51.0.P `parallel` + §51.0.Q hierarchy + §51.12.3.1 computed-delay relaxation + §34 +2 codes E-HISTORY-NO-INNER-ENGINE / E-INTERNAL-RULE-NOT-COMPOSITE). **A1b Wave 3 closer COMPLETE** — B11 + B12 + B13 SHIPPED. **A1b Wave 4 COMPLETE** — B14 + B15 + B16 + B17 SHIPPED. Total: 11 commits at S68. Next dispatch wave: A1b Wave 5 (B18-B22 cross-cutting bundled audit at `7a34226`) OR A7 implementation (A5-2 parser + A5-3 typer + A5-4 codegen).
