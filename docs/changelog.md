...
Current baseline (2026-05-27 **S136 CLOSE**). Full suite **21,831 pass / 3 fail / 170 skip / 1 todo across 804 files** (3 fails are within-node allowlist-baseline drift on error-arm fixtures from cumulative parser-shape shifts; S125 lesson firing again; CARRY-FORWARD to S137 for allowlist rebump; NOT regressions). Net new test files: boolean-keywords-lowering.test.js + error-handler-terminator-arms.test.js + r25-bug-36-bare-error-type.test.js. Full delta from S135 baseline 21,762: +69 (+42 R24-BUG-1 / +18 R24-BUG-2 / +12 R25-Bug-36 - the 3 within-node fails).
