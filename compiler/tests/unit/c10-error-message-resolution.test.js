...
describe("C10 §C10.0 — Chunk wiring", () => {
  ...
  test("RUNTIME_CHUNK_ORDER has 27 chunks total (17 + 'engine' added by C13 + 'prefetch' added by A-4.3 + 'mount' + 'vendor-ref' added by A-4.7 + 'wire' added by v0.3.x SPA tree-shake Phase B 3.2 + 4 'stdlib-*' chunks added by Bug 18 S95 + 'modules' added by known-gaps-#6 S152)", () => {
