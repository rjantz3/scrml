<!-- @digest head=7337ddff delta-seq=14 -->
...
> **HEAD `7337ddff`** + delta-log **[14]**. To check freshness, run `bun scripts/state.ts` and read
> its `digest:` line — it is SOURCE-based (the digest is current unless a commit since stamp `7337ddff`
...
## Board — from `@gap` tokens @ `7337ddff`
...
## State
- Version: 0.7.0 · maps: 5 commits behind HEAD (watermark d931f8be, HEAD 7337ddff)
- Recent wraps:
