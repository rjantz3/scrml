<!-- @digest head=d931f8be delta-seq=14 -->
...
> **HEAD `d931f8be`** + delta-log **[14]**. To check freshness, run `bun scripts/state.ts` and read
> its `digest:` line — it is SOURCE-based (the digest is current unless a commit since stamp `d931f8be`
...
## Board — from `@gap` tokens @ `d931f8be`
